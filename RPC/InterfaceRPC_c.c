    ...
    /* [string][in] */ const unsigned char *password)
{
    ...
    _RetVal = NdrClientCall2(
                  ...
                  (PFORMAT_STRING) &InterfaceRPC__MIDL_ProcFormatString.Format[0],
    ...
    /* [in] */ handle_t IDL_handle)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&InterfaceRPC_StubDesc,
                  (PFORMAT_STRING) &InterfaceRPC__MIDL_ProcFormatString.Format[46],
                  ( unsigned char * )&IDL_handle);
    ...
    /* [out] */ unsigned int *file_size)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&InterfaceRPC_StubDesc,
                  (PFORMAT_STRING) &InterfaceRPC__MIDL_ProcFormatString.Format[74],
                  ( unsigned char * )&IDL_handle);
    return ( unsigned char  )_RetVal.Simple;
    ...
    /* [size_is][out] */ unsigned char *data)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&InterfaceRPC_StubDesc,
                  (PFORMAT_STRING) &InterfaceRPC__MIDL_ProcFormatString.Format[120],
                  ( unsigned char * )&IDL_handle);
    return ( unsigned char  )_RetVal.Simple;
    ...
    /* [size_is][in] */ unsigned char *data)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&InterfaceRPC_StubDesc,
                  (PFORMAT_STRING) &InterfaceRPC__MIDL_ProcFormatString.Format[172],
                  ( unsigned char * )&IDL_handle);
    return ( unsigned char  )_RetVal.Simple;
    ...
    /* [string][in] */ const unsigned char *file_name)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&InterfaceRPC_StubDesc,
                  (PFORMAT_STRING) &InterfaceRPC__MIDL_ProcFormatString.Format[224],
                  ( unsigned char * )&IDL_handle);
    return ( unsigned char  )_RetVal.Simple;
